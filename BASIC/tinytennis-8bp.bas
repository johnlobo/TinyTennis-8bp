...
200 |SETUPSP,29,0,1+2:|SETUPSP,29,9,22:|SETUPSP,29,7,6:|LOCATESP,29,p1y,p1x
...
305 IF PEEK(27471) <> 4 THEN GOTO 310
306 IF PEEK(27472) = 4 THEN CALL &7101,29,7,5
307 |ANIMA,29:GOTO 380
1' lee el teclado y posiciona al personaje
310 IF INKEY(27)=0 THEN IF dir<>0 THEN |SETUPSP,29,7,2:dir=0 ELSE |ANIMA,29:p1x=p1x+1:GOTO 330
320 IF INKEY(34)=0 THEN IF dir<>2 THEN |SETUPSP,29,7,3:dir=2 ELSE |ANIMA,29:p1x=p1x-1
330 IF INKEY(67)=0 THEN IF dir<>1 THEN |SETUPSP,29,7,5:dir=1 ELSE |ANIMA,29:p1y=p1y-2:GOTO 360
340 IF INKEY(69)=0 THEN IF dir<>3 THEN |SETUPSP,29,7,6:dir=3 ELSE |ANIMA,29:p1y=p1y+2
