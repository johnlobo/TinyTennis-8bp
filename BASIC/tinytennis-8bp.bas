...
130 g=1' gravity
140 |SETUPSP,31,0,1' status de la bola
...
190 p1x=40:p1y=10:p1vx=0:p1vy=0:p2vy=0
200 |SETUPSP,29,0,1+4+8:|SETUPSP,29,9,22:|SETUPSP,29,7,5:|SETUPSP,29,7,32:|LOCATESP,29,p1y,p1x
1' SETUP PLAYER 1: sprite 29 -> PLAYER
210 |SETUPSP,28,0,1+4+8:|SETUPSP,28,9,22:|SETUPSP,28,7,6:|SETUPSP,28,7,32:|LOCATESP,28,p1y+150,p1x
...
300 IF PEEK(27471) = 7 AND PEEK(27472) = 3 THEN |SETUPSP,29,7,32:|SETUPSP,28,7,32
...
350 IF INKEY(47)=0 THEN p1vx=0:p1vy=0:p2vy=0:|SETUPSP,29,7,7:|SETUPSP,28,7,4
